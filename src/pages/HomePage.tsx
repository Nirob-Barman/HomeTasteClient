...
import { UtensilsCrossed, ShoppingBag, Truck, ChefHat, Zap, Gift, MapPin, ArrowRight } from "lucide-react";
...
const features = [
  { icon: ChefHat, title: "Home-Cooked Quality", desc: "Real recipes, real ingredients — no factory shortcuts." },
  { icon: Zap, title: "Fast Delivery", desc: "Optimised routes mean your food arrives while it's still hot." },
  { icon: Gift, title: "Loyalty Rewards", desc: "Earn points on every order and redeem them for discounts." },
  { icon: MapPin, title: "Live Order Tracking", desc: "Follow your order from kitchen to door in real time." },
];
    ...
    <>
      ...
      <section className="flex min-h-[calc(100vh-4rem)] flex-col items-center justify-center bg-gradient-to-br from-orange-50 to-amber-50 px-6 text-center">
        ...
        <p className="mt-4 max-w-lg text-lg text-gray-500">
          Order from a curated menu of lovingly prepared dishes and have them delivered to your door — fast.
        </p>
      ...
      <section className="px-6 py-20">
        <div className="mx-auto max-w-4xl">
          <h2 className="mb-12 text-center text-2xl font-bold text-gray-800">How It Works</h2>
      ...
      <section className="bg-gray-50 px-6 py-20">
        <div className="mx-auto max-w-4xl">
          <h2 className="mb-12 text-center text-2xl font-bold text-gray-800">Why HomeTaste?</h2>
      ...
      <footer className="border-t border-gray-100 px-6 py-8 text-center text-xs text-gray-400">
        ...
        <Link to={PATHS.LOGIN} className="hover:text-orange-500">Sign In</Link>
        {" · "}
        <Link to={PATHS.REGISTER} className="hover:text-orange-500">Register</Link>
      </footer>
    </>
  );
}
